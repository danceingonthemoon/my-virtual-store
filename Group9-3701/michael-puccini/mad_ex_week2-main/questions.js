...
function accountGenerator(accountName, initBalance) {
    ...
    return function(amount) {
        bal += amount;
        return `You deposited ${amount} to your ${accountName} Account and the current balance is ${bal}.`;
    }
}
...
function mergeAndExtract(array1, array2) {
    ...
    // First element of the merged array assigned to first, then second and the rest to remaining.
    let [first, second, ...remaining] = merged;
